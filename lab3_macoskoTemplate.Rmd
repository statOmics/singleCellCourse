...
```{r}
url <- "https://github.com/statOmics/singleCellCourse/blob/master/data/sce_after_labsession2.rds?raw=true"
download.file(url,destfile = "./sce_after_labsession2.rds")
sce <- readRDS("./sce_after_labsession2.rds") # 147Mb SCE object
```
