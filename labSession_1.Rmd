...
quantification and data pre-processing on two different scRNA-seq dataset.
...
[Macosko_rmd](./singleCell_MacoskoWorkflow.html)
...
The salmon quantification isimplemented in a small .shell script, which can 
...
[Cuomo_rmd](./singleCell_CuomoWorkflow_template.html)
