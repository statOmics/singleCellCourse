...
```{r}
url <- "https://github.com/statOmics/singleCellCourse/blob/master/data/sce_preprocessed.rds?raw=true"
download.file(url,destfile = "./sce_preprocessed.rds")
sce <- readRDS("./sce_preprocessed.rds")
sce
```
