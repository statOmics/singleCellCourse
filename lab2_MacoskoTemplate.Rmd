...
We have created a 
[DropBox folder](https://www.dropbox.com/sh/3yc9065ri76b2e7/AAAr0z9ZGp3APZ-reH6I0DGQa?dl=0) 
containing convenience files, e.g., a preprocessed `SingleCellExperiment` that 
is the end result of lab session 1.

```{r}
sce <- readRDS("https://www.dropbox.com/sh/3yc9065ri76b2e7/AAAr0z9ZGp3APZ-reH6I0DGQa?dl=0&preview=sce_preprocessed.rds")
```
...
This means that, on average, a gene is lower expressed in cell 1 versus cell 10.
