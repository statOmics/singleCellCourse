...
**TO DO**: Discuss edgeR's `filterByExpr` function here more extensively. It doesn't seem clear from current text what min.prop argument does. Also mention that we typically don't know the cell types used in that filtering procedure.
...
**TO DO**: Explain what `perCellQCMetrics` does.
...
**TO DO**: Briefly explain how this works.
...
**TO DO**: Briefly explain why we need normalization and what we normalize for.
